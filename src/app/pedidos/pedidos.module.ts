...
@NgModule({
  declarations: [ListPedidoComponent, PedidoComponent],
  imports: [
    FormsModule,
    CommonModule,
    A11yModule,
  ...
  exports: [ListPedidoComponent, PedidoComponent, MatTableModule,
    MatButtonModule,
    MatToolbarModule,
    MatFormFieldModule,
    MatSelectModule],
  providers: [PedidoService],
  bootstrap: [ListPedidoComponent, PedidoComponent]
})
